...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 363, 725))
        ...
        self.formLayout_3.setWidget(0, QFormLayout.LabelRole, self.frame_21)
        ...
        self.formLayout_3.setWidget(0, QFormLayout.FieldRole, self.frame_22)
        ...
        self.formLayout_3.setWidget(1, QFormLayout.LabelRole, self.frame_28)
        ...
        self.formLayout_3.setWidget(1, QFormLayout.FieldRole, self.frame_26)
        ...
        self.formLayout_4.setWidget(0, QFormLayout.FieldRole, self.comboBox_12)


        self.verticalLayout_3.addWidget(self.groupBox_2)

        self.groupBox_port = QGroupBox(self.scrollAreaWidgetContents_2)
        self.groupBox_port.setObjectName(u"groupBox_port")
        self.verticalLayout_2 = QVBoxLayout(self.groupBox_port)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.formLayout_port = QFormLayout()
        self.formLayout_port.setObjectName(u"formLayout_port")
        self.formLayout_port.setHorizontalSpacing(20)
        self.formLayout_port.setVerticalSpacing(20)
        self.formLayout_port.setContentsMargins(-1, -1, 0, 0)
        self.label_port = QLabel(self.groupBox_port)
        self.label_port.setObjectName(u"label_port")

        self.formLayout_port.setWidget(0, QFormLayout.LabelRole, self.label_port)

        self.comboBox_port = QComboBox(self.groupBox_port)
        self.comboBox_port.setObjectName(u"comboBox_port")

        self.formLayout_port.setWidget(0, QFormLayout.FieldRole, self.comboBox_port)

        self.label_baudRates = QLabel(self.groupBox_port)
        self.label_baudRates.setObjectName(u"label_baudRates")

        self.formLayout_port.setWidget(1, QFormLayout.LabelRole, self.label_baudRates)

        self.comboBox_baudRates = QComboBox(self.groupBox_port)
        self.comboBox_baudRates.setObjectName(u"comboBox_baudRates")

        self.formLayout_port.setWidget(1, QFormLayout.FieldRole, self.comboBox_baudRates)

        self.label_dataBits = QLabel(self.groupBox_port)
        self.label_dataBits.setObjectName(u"label_dataBits")

        self.formLayout_port.setWidget(2, QFormLayout.LabelRole, self.label_dataBits)

        self.comboBox_dataBits = QComboBox(self.groupBox_port)
        ...
        self.formLayout_port.setWidget(2, QFormLayout.FieldRole, self.comboBox_dataBits)

        self.label_checkBits = QLabel(self.groupBox_port)
        self.label_checkBits.setObjectName(u"label_checkBits")

        self.formLayout_port.setWidget(3, QFormLayout.LabelRole, self.label_checkBits)

        self.comboBox_checkBits = QComboBox(self.groupBox_port)
        ...
        self.formLayout_port.setWidget(3, QFormLayout.FieldRole, self.comboBox_checkBits)

        self.label_stopBits = QLabel(self.groupBox_port)
        self.label_stopBits.setObjectName(u"label_stopBits")

        self.formLayout_port.setWidget(4, QFormLayout.LabelRole, self.label_stopBits)

        self.comboBox_stopBits = QComboBox(self.groupBox_port)
        ...
        self.formLayout_port.setWidget(4, QFormLayout.FieldRole, self.comboBox_stopBits)
        ...
        self.verticalLayout_3.addWidget(self.groupBox_port, 0, Qt.AlignTop)
    ...
    def retranslateUi(self, Frame):
        ...
        self.groupBox_4.setTitle(QCoreApplication.translate("Frame", u"\u5e38\u89c4\u8bbe\u7f6e", None))
        self.label_19.setText(QCoreApplication.translate("Frame", u"\u5f00\u673a\u542f\u52a8", None))
        self.comboBox_14.setItemText(0, QCoreApplication.translate("Frame", u"\u4e0d\u5f00\u542f", None))
        self.comboBox_14.setItemText(1, QCoreApplication.translate("Frame", u"\u5f00\u542f", None))
        ...
        self.comboBox_19.setItemText(0, QCoreApplication.translate("Frame", u"\u4e0d\u9690\u85cf", None))
        self.comboBox_19.setItemText(1, QCoreApplication.translate("Frame", u"5\u79d2", None))
        ...
        self.comboBox_12.setItemText(0, QCoreApplication.translate("Frame", u"\u9ed8\u8ba4", None))
        self.comboBox_12.setItemText(1, QCoreApplication.translate("Frame", u"1.0\u79d2", None))
        self.comboBox_12.setItemText(2, QCoreApplication.translate("Frame", u"10\u79d2", None))
        self.comboBox_12.setItemText(3, QCoreApplication.translate("Frame", u"1\u5206\u949f", None))
        self.comboBox_12.setItemText(4, QCoreApplication.translate("Frame", u"30\u5206\u949f", None))

        self.groupBox_port.setTitle(QCoreApplication.translate("Frame", u"\u4e32\u53e3\u8bbe\u7f6e", None))
